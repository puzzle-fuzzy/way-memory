...
- 当前源码：`896c785`（`main` 已推送到 `origin/main`）。
...
- 与该源码绑定的 Debug APK SHA-256：`776975c73f476ece949e06397e864000cfccfd9309bbb22c5fe94d0c9cfd3736`；它已在 `emulator-5554` 安装启动，但模拟器证据仅覆盖协议和生命周期，不计入真实传感器验收。
